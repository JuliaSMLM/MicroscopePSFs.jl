...
dipole = DipoleVector(0.0, 0.0, 1.0)  # aligned with optical axis
emitter_dipole_z0 = DipoleEmitter3D(center_x, center_y, 0.0, 10.0, 0.0, 0.0, 1.0)
emitter_dipole_z1 = DipoleEmitter3D(center_x, center_y, 1.0, 10.0, 0.0, 0.0, 1.0)
